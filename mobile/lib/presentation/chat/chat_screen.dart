                                      ...
                                      : Padding(
                                          ...
                                          child: MarkdownBody(
                                            ...
                                            styleSheet: MarkdownStyleSheet(
                                              ...
                                              h4: TextStyle(color: VegaTheme.textPrimary, fontSize: 18, fontWeight: FontWeight.bold),
                                              h5: TextStyle(color: VegaTheme.textPrimary, fontSize: 16, fontWeight: FontWeight.bold),
                                              h6: TextStyle(color: VegaTheme.textPrimary, fontSize: 15, fontWeight: FontWeight.bold),
                                              ...
                                              del: TextStyle(color: VegaTheme.textSecondary, decoration: TextDecoration.lineThrough),
                                              ...
                                              horizontalRuleDecoration: BoxDecoration(
                                                border: Border(top: BorderSide(color: VegaTheme.border, width: 1)),
                                              ),
                                              ...
                                              blockSpacing: 8,
                                              listSpacing: 4,Style(color: VegaTheme.textPrimary, fontSize: 15),
